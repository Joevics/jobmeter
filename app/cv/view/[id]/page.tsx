...
const handleDownload = async () => {
  ...
  try {
    ...
    // Open a hidden iframe and use the browser's native print-to-PDF
    ...
    // Clean up after a short delay (enough time for print dialog to open)
